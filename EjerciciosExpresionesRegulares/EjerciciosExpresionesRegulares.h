...
protected:
	...
	void GetDialogTemplate(DLGTEMPLATE& dlgTemplate)
	{
		...
		dlgTemplate.cy = Sys::Convert::PixelToDlgUnitY(52);
	...
	void InitializeGui()
	{
		...
		btMatch.Create(NULL, L"Match", WS_CHILD | WS_TABSTOP | WS_VISIBLE | BS_PUSHBUTTON | BS_CENTER | BS_VCENTER, 231, 17, 83, 28, hWnd, 1002);
